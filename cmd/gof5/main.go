...
func main() {
	...
	flag.StringVar(&opts.KeychainPath, "keychain", "", "Path to a keychain file")
	flag.StringVar(&opts.KeychainLabel, "keychain-label", "", "Keychain label")
	flag.StringVar(&opts.CertSerial, "cert-serial", "", "Certificate serial number")
